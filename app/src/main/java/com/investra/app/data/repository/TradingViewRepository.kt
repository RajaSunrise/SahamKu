    ...
    fun getFallbackStocks(category: String = "gainers"): List<Stock> {
        val list = when (category) {
            ...
            "active" -> listOf(
                ...
                Stock("GOOGL", "Alphabet Inc", "NASDAQ", 165.10, 2.10, 1.29, 8800000000.0, "8.8B", 0.68, "BUY ON DIP", 48.5, "Fib 61.8% Bounce", 162.00, 158.00, "Internet Media", "Communication", 2.0e12, "Reversal Candlestick Hammer", 161.5, 168.0, 173.2, 182.0, 159.0, logoUrl = "https://s3-symbol-logo.tradingview.com/alphabet.svg")
            )
